...
<body>
  ...
  <div class="page-header">
    <h1 class="category-title">Footwear</h1>
  ...
  <div class="products-grid">
    ...
    <a href="product.php?id=<?php echo $prod['product_id']; ?>&return=footwear&page=<?php echo $page; ?>" class="product-card" style="position: relative;">
